...
declare global {
  ...
  const useConsole: typeof import('./composables/use-console')['useConsole']
  ...
  const useTypeLoadingState: typeof import('./composables/useTypeLoadingState')['useTypeLoadingState']
...
declare global {
  ...
  // @ts-ignore
  export type { ConsoleLevel, ConsoleLogPayload, ConsoleGroupPayload, ConsolePayload } from './composables/use-console'
  import('./composables/use-console')
}
